...
// handles (or type exact times), and download only that section. The Home
// screen owns the on/off pill; this renders the editor only while a section
// is set.
...
export function TrimEditor({
  ...
  return (
    <div className="trim-body fade-up">
      {canPreview ? (
